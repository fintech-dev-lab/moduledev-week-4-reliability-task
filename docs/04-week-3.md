...
Ниже перечислены обязательные технические требования полного соответствия.
Учебный зачёт `learning-outcome.1` отдельно подтверждает воспроизводимость, архитектуру,
работающие процессы, единственность эффекта, доказательство финала, полномочия,
согласованность истории и долговечную доставку. Частные нарушения форматов сохраняются
в замечаниях и баллах; отказ в зачёте требует доказанного нарушения одного из этих условий.
Непроверенное критическое свойство означает «Недостаточно данных». Полные правила —
в [калибровке недель 3–4](review-calibration-weeks-3-4.md).
