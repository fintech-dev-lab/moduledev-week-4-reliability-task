...
До даты выдачи задания этот repository имеет visibility `PRIVATE`. При публикации меняется только visibility, не commit задания.
...
- [Trace payload/result schemas](contracts/course-1)
